        ...
        <main className="flex-grow">
          ...
          <div className="space-y-8">
            <section id="about">
              ...
              <p className="mb-4"><strong>1.3 Service Domain and Scope:</strong> The AI-SOC 1 system operates across three dedicated domains, each serving a distinct functional role: (i) <strong>web-soc.silence.codes</strong> — the Centralized Management Console (CMC) for the Web Security &amp; Traffic Management subsystem, accessible to administrators; (ii) <strong>email-soc.silence.codes</strong> — the Centralized Management Console (CMC) for the Email Security &amp; Visualization subsystem, accessible to administrators; and (iii) <strong>mail.silence.codes</strong> — the Webmail Client through which end users send and receive emails, accessible to users without administrative privileges. These Terms of Use apply exclusively to services accessible through the aforementioned domains. Any services provided on different domains are subject to separate terms and policies.</p>
            </section>
            <section id="service-description">
              ...
              <p className="mb-4"><strong>2.3 Pricing Information:</strong> Current pricing for AI-SOC 1 services is available on our website at <a href="https://silence.codes/en/ai-soc/" className="text-blue-400 hover:text-blue-300 underline" target="_blank" rel="noopener noreferrer">silence.codes/en/ai-soc/</a>. We reserve the right to modify our pricing at any time. Price changes will be communicated through our platform and will take effect for new billing cycles after the notification period.</p>
            </section>
            <section id="sla">
