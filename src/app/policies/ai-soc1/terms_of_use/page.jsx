        ...
        <main className="flex-grow">
          ...
          <div className="space-y-8">
            <section id="about">
              ...
              <p className="mb-4"><strong>1.3 Service Domain and Scope:</strong> The AI-SOC 1 system and all services governed by these Terms of Use are operated exclusively on the domain aisoc1.silence.codes and its associated subdomains, including but not limited to email.aisoc1.silence.codes (Email Security &amp; Visualization subsystem) and web.aisoc1.silence.codes (Web Security &amp; Traffic Management subsystem). These Terms of Use apply exclusively to services accessible through the aforementioned domains and subdomains. Any services provided on different domains are subject to separate terms and policies.</p>
            </section>
