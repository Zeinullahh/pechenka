...
function init_protocol() {
 ...
 <h2 className="relative text-7xl md:text-8xl font-bold text-center text-white tracking-tight" style={{ textShadow: '0 4px 20px rgba(0,0,0,0.5)' }}>Kainedin Zhannur</h2>
 </div>
 ...
 <p className="font-mono text-base text-blue-300 font-bold mb-3">SLNC-INT-26-0903-KZH</p>
 <p className="text-xs font-mono text-white/80 break-all max-w-full whitespace-nowrap">silence.codes/interns/flow-1/SLNC-INT-26-0903-KZH</p>
 </div>
