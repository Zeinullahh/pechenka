...
<main className="relative flex-grow flex flex-col items-center justify-start pt-28 px-4 pb-20 sm:px-6 z-10 w-full print:p-0 print:pb-0 print:pt-0">
 ...
 className={`flex items-center gap-2 text-white px-6 py-3 rounded-full shadow-lg transition-all font-semibold ${
 isGenerating
 ...
 width: '1100px', 
 aspectRatio: '1.414/1',
 background: 'radial-gradient(ellipse at center, #1a2a50, #0d1530 50%, #060a18)',
 }}
 >
 ...
 {/* Background Pattern for Web (Faint Code Snippets) */}
...
function init_protocol() {
 ...
 {/* Moonrise background at the bottom - faded seamlessly and moved lower */}
 <div 
 ...
 {/* Elegant Inner Frame removed to give more space */}
 ...
 {/* Elegant Glow behind name */}
 <div className="absolute -inset-8 bg-blue-500/10 blur-2xl rounded-full opacity-80 " />
 <h2 className="relative text-7xl md:text-8xl font-bold text-center text-white tracking-tight" style={{ textShadow: '0 4px 20px rgba(0,0,0,0.5)' }}>
 Kapyshev Khajimurat
 </h2>
 </div>
 ...
 Has successfully completed <span className="font-medium text-blue-300 border-b border-blue-400/30 pb-1">Internship Flow 1</span>
 </p>
 <p className="text-white/50 text-lg uppercase tracking-widest text-sm">
 Winter Internship Batch • Secure Software Solutions
 </p>
 </div>
 ...
 silence.codes/interns/flow-1/SLNC-INT-26-0903-KK
 </p>
 </div>
 ...
 */}
 ...
 body { 
            ...
            /* Hide footer from LayoutWrapper */
            footer {
